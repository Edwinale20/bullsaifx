...
umbral_uptd = st.sidebar.slider('Filtrar artículos con UPTD mayor a:', 0, int(INV['UPTD'].max()), 0, 1)
...
if umbral_uptd > 0:
    df_venta_perdida_filtrada = df_venta_perdida_filtrada[df_venta_perdida_filtrada['UPTD'] > umbral_uptd]
#----------------------------------------------------------------------------------------
